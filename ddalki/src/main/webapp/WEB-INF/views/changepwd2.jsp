...
<h3 style="margin:20px 0 0 50px" class="navbar-text"><span class="label label-default">email</span><span style="margin: 27px">${email}</span></h3><br><br>
<form class="form-horizontal" style="width: 650px;margin: 30px">
